...
insert into items(id, code, price, state, user_id, description) values(nextval('items_id_seq'), 1234567890, 34.34, 'ACTIVE', currval('users_id_seq'), 'White cotton sheets');
...
insert into suppliers(id, country, name) values(nextval('suppliers_id_seq'), 'ES', 'Supplier Example');
...
insert into items(id, code, price, state, user_id, description) values(nextval('items_id_seq'), 1234567891, 12.3, 'ACTIVE', currval('users_id_seq'), 'Refined birch chair');
