...
insert into items(id, code, price, state, user_id, description) values(nextval('items_id_seq'), 1234567890, 34.34, 'ACTIVE', currval('users_id_seq'), 'Description');
...
insert into items(id, code, price, state, user_id, description) values(nextval('items_id_seq'), 1234567895, 34.34, 'ACTIVE', currval('users_id_seq'), 'Description');
